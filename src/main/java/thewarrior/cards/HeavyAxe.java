...
public class HeavyAxe extends AbstractWarriorAttackCard {
	...
	class Axe1 extends AbstractWarriorSubcard {
		...
		public void use(AbstractPlayer p, AbstractMonster m) {
			...
			ComboAction.comboCardManager.add(new ApplyPowerAction(m, p, new DazedPower(m, 8), 8));
		}
	...
	class Axe2 extends AbstractWarriorSubcard {
		...
		public void use(AbstractPlayer p, AbstractMonster m) {
			...
			ComboAction.comboCardManager.add(new MakeTempCardInDrawPileAction(new Fatigue(), 1, true, true));
		}
