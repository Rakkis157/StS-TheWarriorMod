...
public class SpecialHammer extends AbstractWarriorAttackCard {
	...
	class Hammer1 extends AbstractWarriorSubcard {
		...
		public void use(AbstractPlayer p, AbstractMonster m) {
			...
			ComboAction.comboCardManager.add(new DiscardAction(p, p, 1, false));
	...
	class Hammer2 extends AbstractWarriorSubcard {
		...
		public void use(AbstractPlayer p, AbstractMonster m) {
			...
			ComboAction.comboCardManager.add(new ApplyPowerAction(m, p, new DazedPower(m, 23), 23));
		}
	...
	class Hammer3 extends AbstractWarriorSubcard {
		...
		public void use(AbstractPlayer p, AbstractMonster m) {
			...
			ComboAction.comboCardManager.add(new ApplyPowerAction(m, p, new DazedPower(m, 37), 37));
		}
