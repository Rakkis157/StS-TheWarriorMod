...
import thewarrior.powers.SpikyShieldPower;

public class SpikyShield extends AbstractWarriorCard {
	public static final String ID = "TheWarrior:SpikyShield";
	...
	public void use(AbstractPlayer p, AbstractMonster m) {
		...
		if (effect > 0) { // play card
			...
			AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p, p, new SpikyShieldPower(magicNumber), magicNumber));
		}
