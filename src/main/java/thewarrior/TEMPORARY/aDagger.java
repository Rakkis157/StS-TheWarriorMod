 ...
 * 
 * public class aDagger extends AbstractWarriorAttackCard {
 * public static final String ID = "TheWarrior:aDagger";
 ...
 * private static final int SPEED = 15;
 * private static final int CUT_DAMAGE = 4;
